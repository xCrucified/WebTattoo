...
export const Header: React.FC<Props> = ({ className }) => {
  return (
    <header
      className={cn(className, "w-full shadow-md h-[100px] bg-[#0000005c]")}
    >
      <div className="flex items-center justify-between mx-auto h-full max-w-[1800px]">
        <a href="#home" className="flex items-center space-x-3 nav-item w-full h-full">
          <Image
        ...
        <nav className="text-[#acacad] w-[43%] h-[100%] text-xl">
